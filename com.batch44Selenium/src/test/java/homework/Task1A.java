    ...
    public static void main(String[] args) throws InterruptedException {
       ...
       // opera.manage().window().fullscreen();
        ...
        if (operaTitleHepsiBurada.contains(testWord) && operaUrlHepsiBurada.contains(testWord)) {
            System.out.println("Opera hepsiburada contains 'burada' test PASS");
        } else {
            System.out.println("Opera hepsiburada contains 'burada' test FAILED");
        }
